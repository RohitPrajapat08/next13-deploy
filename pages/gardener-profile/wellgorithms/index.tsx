...
export default function Blogs() {
  ...
  const { data, error } = useSWR(
    `${process.env.NEXT_PUBLIC_APP_BASEURL}/getwellgoinarticle?gardnerid=${UserData?.uniqueId}`,
    fetcher
  );
  console.log(data, error, "getwellgoinarticle");
  return (
    <>
              ...
              <Col md={9}>
                <div className={`${cx.contentBody}`}>
                  ...
                  <div className={`${cx.contentInside}`}>
                    <ul className={`${cx.wellgorithmList}`}>
