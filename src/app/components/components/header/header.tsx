      ...
      <section className={`${cx.DropdownOption}`}>
        <Container>
          <OwlCarousel className="owl-theme" {...options}>
            <div className="item">
              <Link href="/sub-category" className={`btn ${cx.dropBtn}`}>
                Peace
              </Link>
            </div>
            <div className="item">
              <button className={`btn ${cx.dropBtn}`}>love</button>
            </div>
            <div className="item">
              <button className={`btn ${cx.dropBtn}`}>kindness</button>
            </div>
            <div className="item">
              <button className={`btn ${cx.dropBtn}`}>joy</button>
            </div>
            <div className="item">
              <button className={`btn ${cx.dropBtn}`}>Hope</button>
            </div>
            <div className="item">
              <button className={`btn ${cx.dropBtn}`}>Confidence</button>
            </div>
            <div className="item">
              <button className={`btn ${cx.dropBtn}`}>Awe</button>
            </div>
            <div className="item">
              <button className={`btn ${cx.dropBtn}`}>Wonder</button>
            </div>
            <div className="item">
              <button className={`btn ${cx.dropBtn}`}>Humility</button>
            </div>
          </OwlCarousel>
